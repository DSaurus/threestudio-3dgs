...
def main(args, extras) -> None:
    ...
    if args.typecheck:
        ...
        install_import_hook("gsstudio", "typeguard.typechecked")

    import gsstudio
    from gsstudio.system.base import BaseSystem
    from gsstudio.utils.callback import (
        CodeSnapshotCallback,
        ConfigSnapshotCallback,
        CustomProgressBar,
        ProgressCallback,
    )
    from gsstudio.utils.config import ExperimentConfig, load_config
    from gsstudio.utils.misc import get_rank
    from gsstudio.utils.typing import Optional
    ...
    dm = gsstudio.find(cfg.data_type)(cfg.data)
    system: BaseSystem = gsstudio.find(cfg.system_type)(
